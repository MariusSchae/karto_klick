...
class KartoKlick:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&KartoKlick')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('KartoKlick', message)
